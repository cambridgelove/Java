...
// To run them on the command line, make sure that the junit-4.11.jar
// is in the PA directory.
// 
// $> javac -cp .:junit-4.11.jar *.java #compile everything
// $> java -cp ..:junit-4.11.jar numbersys.P5TestsCrude #run tests
// 
// If you are a Windows user, modify the above by replacing : with ;
// as in the following:
// 
// $> javac -cp .;junit-4.11.jar *.java 
// $> java -cp ..;junit-4.11.jar numbersys.P5TestsCrude
package numbersys;
...
import static numbersys.CrudeNumberConvert.*;
  
public class P5TestsCrude {
  // Tests for Problem 1.
  @Test
  public void toInt_1(){
    String s="00123_10";
  ...
  public static void main(String args[]){
    org.junit.runner.JUnitCore.main("numbersys.P5TestsCrude");
  }
